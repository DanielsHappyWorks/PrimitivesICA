...
namespace GDLibrary
{
    ...
    public static class VertexFactory
    {
        ...
        public static VertexPositionColorTexture[] GetVerticesPositionColorTexturedDiamond(int sidelength, out PrimitiveType primitiveType, out int primitiveCount)
        {
            primitiveType = PrimitiveType.TriangleList;
            primitiveCount = 10;

            VertexPositionColorTexture[] vertices = new VertexPositionColorTexture[30];
            float halfSideLength = sidelength / 2.0f;
            ...
            Vector2 uvBottomLeft = new Vector2(0, 1);
            Vector2 uvBottomRight = new Vector2(1, 1);
            Vector2 uvBottomCentre = new Vector2(0, 0.5f);
            ...
            //bottom front 
            vertices[18] = new VertexPositionColorTexture(bottomCentre, Color.White, uvBottomCentre);
            vertices[19] = new VertexPositionColorTexture(frontRight, Color.White, uvBottomRight);
            vertices[20] = new VertexPositionColorTexture(frontLeft, Color.White, uvBottomLeft);

            //bottom left 
            vertices[21] = new VertexPositionColorTexture(bottomCentre, Color.White, uvBottomCentre);
            vertices[22] = new VertexPositionColorTexture(frontLeft, Color.White, uvBottomRight);
            vertices[23] = new VertexPositionColorTexture(backLeft, Color.White, uvBottomLeft);

            //bottom right 
            vertices[24] = new VertexPositionColorTexture(bottomCentre, Color.White, uvBottomCentre);
            vertices[25] = new VertexPositionColorTexture(backRight, Color.White, uvBottomRight);
            vertices[26] = new VertexPositionColorTexture(frontRight, Color.White, uvBottomLeft);

            //bottom back 
            vertices[27] = new VertexPositionColorTexture(bottomCentre, Color.White, uvBottomCentre);
            vertices[28] = new VertexPositionColorTexture(backLeft, Color.White, uvBottomRight);
            vertices[29] = new VertexPositionColorTexture(backRight, Color.White, uvBottomLeft);
